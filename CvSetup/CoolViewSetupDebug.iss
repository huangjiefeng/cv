...
#define MyAppName "CoolView"#define MyAppVersion GetFileVersion(AddBackslash(SourcePath) + "Debug\CoolView\CoolView.exe")
...
OutputBaseFilename={#MyAppName}D_Setup_{#MyAppVersion}
OutputDir="."
Compression=lzma
...
Source: "{#CompileMode}\filter\*.dll";    DestDir: "{app}\filter"; Flags: ignoreversion restartreplace regserver;     
Source: "{#CompileMode}\filter\*.pdb";    DestDir: "{app}\filter"; Flags: ignoreversion restartreplace; 

...
/************************************************************************/
/* Log macro for encoder                                                */
/************************************************************************/

#define LOG_ENC_ERROR(message, ...) \
	msdxLogFunction(MSDX_LOG_LEVEL_ERROR, \
	__FILE__, \
	__LINE__,\
	"[Enc:%4d]: "message, \
...
#define LOG_PRINTF(x, ...) printf_s("[SCUT_X264_DEC] " x, __VA_ARGS__)

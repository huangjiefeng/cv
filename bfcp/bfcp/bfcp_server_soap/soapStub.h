...
/* ns:ErrorCode */
enum ns__ErrorCode { kNoError = 0, kUserNotExist = 1, kUserAlreadyExist = 2, kFloorNotExist = 3, kFloorAlreadyExist = 4, kChairNotExist = 5, kChairAlreadyExist = 6, kConferenceNotExist = 7, kConferenceAlreadyExist = 8, kServerNotStart = 9, kServerAlreadyStart = 10 };
#endif

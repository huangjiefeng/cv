...
//#include <presentation/qt/imaccount/QtIMAccountSettings.h> 精简zhenHua.sun 2010-09-03
...
QtSimpleIMContactManager::QtSimpleIMContactManager(ContactProfile & contactProfile,
	...
	*/
	...
	QRegExp exgExp(tr("^[0-9a-zA-Z]+([\\._-][0-9a-zA-Z]+)*@[0-9a-zA-Z]+(\\.[0-9a-zA-Z]+)*$"));
	_ui->sipLineEdit->setValidator(new QRegExpValidator(exgExp , this));
	loadIMContacts();
}

QtSimpleIMContactManager::~QtSimpleIMContactManager() {
	/* 精简 ...zhenHua.sun 2010-09-21

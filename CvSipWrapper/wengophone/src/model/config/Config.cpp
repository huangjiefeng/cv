...
const string Config::VIDEO_FRAME_WIDTH_KEY = "video.frame.width";
const string Config::VIDEO_FRAME_HEIGHT_KEY = "video.frame.height";
const string Config::VIDEO_BITRATE_KEY = "video.bitrate";
const string Config::VIDEO_CODEC_SERIAL = "video.codec.serial";
const string Config::SIP_GLOBAL_SERVICE = "sip.global.service";
const string Config::IP_VERSION = "ip.version";
const string Config::IP_ADDRESS = "ip.address";
const string Config::IS_MULTICAST = "ip.multicast";
const string Config::SIP_ACCOUNT_PASSWORDREMEMBER_KEY = "sip.account.passwordremember";
const string Config::SIP_ACCOUNT_AUTOCONNECT_KEY = "sip.account.autoconnect";
/************************************************************************/

//for crossbar.........................................................add by zhenHua.sun 2010-07-17
const string Config::CROSSBAR_NAME = "video.webcam.crossbar_name";
const string Config::CROSSBAR_INPUT_TYPE = "video.webcam.crossbar_input_type";

//for audiocodec.......................................................add by zhenHua.sun 2010-07-20
const string Config::AUDIO_CHANNELS = "audio.codec.channels";
const string Config::AUDIO_SAMPLE_RATE = "audio.codec.samplerate";
const string Config::AUDIO_BITS_PER_SAMPLE = "audio.codec.bitspersample";
...
const string Config::QOS_SERVER_SIP_URI_KEY="qos.serversipuri";

const string Config::QOS_SIMULATOR_SIP_URI_KEY="qos.simulatorsipuri";

const string  Config::SIP_USE_TYPING_STATE="sip.usetypingstate";
...
/************************************************************************////Add by zhuang 08-12-23
int Config::getVideoFrameWidth() const {
	return getIntegerKeyValue(VIDEO_FRAME_WIDTH_KEY);
}

int Config::getVideoFrameHeight() const {
	return getIntegerKeyValue(VIDEO_FRAME_HEIGHT_KEY);
}

int Config::getVideoBitRate() const {
	return getIntegerKeyValue(VIDEO_BITRATE_KEY);
}

string Config::getVideoCodecSerial() const
{
	return getStringKeyValue(VIDEO_CODEC_SERIAL);
}

string Config::getGlobalService() const
{
	return getStringKeyValue(SIP_GLOBAL_SERVICE);
}

int Config::getIPVersion() const {
	return getIntegerKeyValue(IP_VERSION);
}

string Config::getIPAddress() const
{
	return getStringKeyValue(IP_ADDRESS);
}

bool Config::getIsMulticast() const
{
	return getBooleanKeyValue(IS_MULTICAST);
}

bool Config::getPasswordRemember() const
{
	return getBooleanKeyValue(SIP_ACCOUNT_PASSWORDREMEMBER_KEY);
}

bool Config::getAutoConnect() const
{
	return getBooleanKeyValue(SIP_ACCOUNT_AUTOCONNECT_KEY);
}
/************************************************************************/


//...................................................start add by zhenHu.sun 2010-07-17

string Config::getCrossbarName() const
{
	return getStringKeyValue( CROSSBAR_NAME );
}

string Config::getCrossbarInputType() const
{
	return getStringKeyValue( CROSSBAR_INPUT_TYPE );
}

//...................................................end
//...................................................start add by zhenHu.sun 2010-07-30

int Config::getAudioBitsPerSample() const
{
	return getIntegerKeyValue( AUDIO_BITS_PER_SAMPLE );
}

int Config::getAudioChannels() const
{
	return getIntegerKeyValue( AUDIO_CHANNELS );
}

int Config::getAudioSampleRate() const
{
	return getIntegerKeyValue( AUDIO_SAMPLE_RATE );
}
//...................................................end
...
std::string Config::getQosServerSipUri() const
{
	return getStringKeyValue(QOS_SERVER_SIP_URI_KEY);
}

std::string Config::getSimulatorServerSipUri() const
{
	return getStringKeyValue(QOS_SIMULATOR_SIP_URI_KEY);
}
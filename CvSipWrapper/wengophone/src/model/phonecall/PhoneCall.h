...
//	Event<void (PhoneCall & sender, piximage * remoteVideoFrame, piximage * localVideoFrame)> videoFrameReceivedEvent;
	Event<void (PhoneCall & sender, void * video_hwnd, piximage * localVideoFrame)> videoFrameReceivedEvent;
	/************************************************************************/
	...
	void videoFrameReceived(void * video_hwnd, piximage * localVideoFrame);
	/************************************************************************/

...
#define WENGOPHONE_UA "wengo/v1/wengophoneng/wengo/rev3ef77e19b903/trunk/"
...
owplCallConnect2(const OWPL_CALL hCall,
				const char* szAddress,
				int mediaStreams,int width,int height,int bitrate,const char *codecSerial);
/************************************************************************/
/**
...
/*重载                                                                  */
MY_DLLEXPORT OWPL_RESULT owplCallAnswer2(const OWPL_CALL hCall, int mediaStreams,int width,int height,int bitrate,const char *codecSerial);
/************************************************************************/
...
MY_DLLEXPORT OWPL_RESULT 
owplInfoCall(const OWPL_CALL hCall,char * szContent,char * szMIME);

MY_DLLEXPORT int phapi_media_send_start(char * AudioIP,int AudioPort,char * VideoIP,int VideoPort,HWND previewHwnd,void *pClass,void *func,int videoWidth,int videoHeight);

MY_DLLEXPORT void phapi_media_send_stop(char * AudioIP,int AudioPort,char * VideoIP,int VideoPort);

MY_DLLEXPORT int phapi_media_recv_start(const char *userId,char * AudioIP,int AudioPort,char * VideoIP,int VideoPort,char *codecMIME,HWND remoteHwnd,int videoWidth,int videoHeight,void *pClass,void *func);

MY_DLLEXPORT void phapi_media_recv_stop(const char *userId);

//屏幕共享
MY_DLLEXPORT int phapi_screen_share_send_start(char * ScreenIP,int ScreenPort,int x,int y,int width,int height);
//取消桌面共享
MY_DLLEXPORT void phapi_screen_share_send_stop(char * ScreenIP,int ScreenPort);
//接收桌面共享
MY_DLLEXPORT int phapi_screen_share_recv_start(char * ScreenIP,int ScreenPort,HWND remoteHwnd,int videoWidth,int videoHeight);
//取消接收桌面共享
MY_DLLEXPORT void phapi_screen_share_recv_stop();

MY_DLLEXPORT void phapi_exit_conference();

MY_DLLEXPORT void phapi_resize_video_window(const char *userId,const HWND remoteHwnd,int fullscreenflag);

//禁止发言
MY_DLLEXPORT void phapi_forbid_speak(char * AudioIP,int AudioPort);

MY_DLLEXPORT void phapi_forbid_speak2(char * userId);
//允许发言
MY_DLLEXPORT void phapi_permit_speak(char * AudioIP,int AudioPort);

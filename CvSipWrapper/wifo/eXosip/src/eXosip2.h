...
int  generating_register_with_message(osip_message_t **reg, char *transport, char *from, char *proxy, int expires, char *route, int seqnum,const char*msg,const char*mime );

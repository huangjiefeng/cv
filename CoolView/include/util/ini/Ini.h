...
//
// @see http://www.codeproject.com/KB/cpp/CIni.aspx
// 7/08/2002    Bin Liu
//
// Update history:
//
...
public:		
	...
	LONGLONG  GetInt64(LPCTSTR lpSection, LPCTSTR lpKey, LONGLONG nDefault, int nBase = BASE_DECIMAL) const;
	BOOL WriteInt64(LPCTSTR lpSection, LPCTSTR lpKey, LONGLONG nValue, int nBase = BASE_DECIMAL) const;
	BOOL IncreaseInt64(LPCTSTR lpSection, LPCTSTR lpKey, LONGLONG nIncrease = 1, int nBase = BASE_DECIMAL) const;

	ULONGLONG GetUInt64(LPCTSTR lpSection, LPCTSTR lpKey, ULONGLONG nDefault, int nBase = BASE_DECIMAL) const;
	BOOL WriteUInt64(LPCTSTR lpSection, LPCTSTR lpKey, ULONGLONG nValue, int nBase = BASE_DECIMAL) const;
	BOOL IncreaseUInt64(LPCTSTR lpSection, LPCTSTR lpKey, ULONGLONG nIncrease = 1, int nBase = BASE_DECIMAL) const;
...
protected:	
	...
	static void __UInt64ToBinaryString(ULONGLONG nNumber, LPTSTR lpBuffer, DWORD dwBufSize);
	static int __ValidateBase(int nBase);
	static void __IntToString(int nNumber, LPTSTR lpBuffer, int nBase);
	static void __Int64ToString(LONGLONG nNumber, LPTSTR lpBuffer, int nBase);
	static void __UIntToString(UINT nNumber, LPTSTR lpBuffer, int nBase);
	static void __UInt64ToString(ULONGLONG nNumber, LPTSTR lpBuffer, int nBase);

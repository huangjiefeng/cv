...
void CvCoreAdaptor::CloseCoolViewSlotDbus()
{
    // handle method call com.dcampus.coolview.core.CloseCoolViewSlotDbus
    QMetaObject::invokeMethod(parent(), "CloseCoolViewSlotDbus");
}

void CvCoreAdaptor::MoveToMainThreadSlot()
{
    // handle method call com.dcampus.coolview.core.MoveToMainThreadSlot
    QMetaObject::invokeMethod(parent(), "MoveToMainThreadSlot");
}

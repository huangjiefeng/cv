...
void CoreService2::Initialize( IControllerManager *controller_manager ) {
  ...
  connect(
	  this, &CoreService2::CloseCoolViewSignal,
	  system_controller, &ISystemController::HandleQuitSystemRequestSlot);//关闭coolview --hjf
...
void CoreService2::CloseCoolViewSlotDbus(){
	qDebug() << "fuck!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
	//emit CloseCoolViewSignal();
}

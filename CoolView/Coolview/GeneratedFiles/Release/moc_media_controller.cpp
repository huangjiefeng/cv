/****************************************************************************
** Meta object code from reading C++ file 'media_controller.h'
**
...
#error "The header file 'media_controller.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MediaController_t, stringdata) + ofs \
...
const QMetaObject MediaController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MediaController.data,
      qt_meta_data_MediaController,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MediaController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MediaController.stringdata))

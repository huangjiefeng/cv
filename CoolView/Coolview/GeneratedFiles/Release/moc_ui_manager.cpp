/****************************************************************************
** Meta object code from reading C++ file 'ui_manager.h'
**
...
#error "The header file 'ui_manager.h' doesn't include <QObject>."
...
const QMetaObject UIManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UIManager.data,
      qt_meta_data_UIManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};

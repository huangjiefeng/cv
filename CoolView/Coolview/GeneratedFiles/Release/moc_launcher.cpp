...
QT_MOC_LITERAL(1, 9, 26), // "StartSendStreamMediaSignal"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 26) // "ReceiveAllLocalMediaSignal"

    },
    "Launcher\0StartSendStreamMediaSignal\0"
    "\0ReceiveAllLocalMediaSignal"
};
...
void Launcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->StartSendStreamMediaSignal(); break;
        case 1: _t->ReceiveAllLocalMediaSignal(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Launcher::StartSendStreamMediaSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (Launcher::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Launcher::ReceiveAllLocalMediaSignal)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Launcher::StartSendStreamMediaSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void Launcher::ReceiveAllLocalMediaSignal()
{
